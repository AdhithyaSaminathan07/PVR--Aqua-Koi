...
const Dashboard = () => {
    ...
    const fetchStats = async () => {
        try {
            setLoading(true);
            const [custRes, ordRes, taskRes, prodRes, enqRes, remRes] = await Promise.all([
                getCustomers(), getOrders(), getTasks(), getProducts(), getEnquiries(), getServiceReminders()
            ]);
            ...
            setStats({
                ...
                componentAlerts: remRes.data?.componentAlerts?.length || 0,
