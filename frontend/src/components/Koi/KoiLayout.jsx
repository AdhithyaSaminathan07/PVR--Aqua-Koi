        ...
        <div className="flex h-screen bg-[#FFF7ED] overflow-hidden font-sans relative">
            ...
            >
                ...
                <div className="flex-1 w-full overflow-y-auto custom-scrollbar no-print">
                    <div className="space-y-4">
                        ...
                        {(['BOSS', 'MANAGER', 'KOI', 'KOIMANAGER', 'BRANCHMANAGER', 'ADMIN'].includes(role)) && (
                            <div className="pt-2">
                                {(isHovered || isMobileMenuOpen) && (
                                    <motion.h3
                                        initial={{ opacity: 0 }}
            ...
            <div className="flex-1 flex bg-[#FFF7ED] relative overflow-hidden">
                <div className="flex-1 flex flex-col overflow-hidden bg-white m-0 lg:m-4 lg:rounded-2xl shadow-xl shadow-orange-900/5 relative">
                    <header className="h-20 flex items-center px-4 md:px-8 lg:px-12 gap-4 no-print border-b border-gray-50 text-orange-900/80">
                        {/* Mobile Menu Toggle (Left Side) */}
                        <button
                            onClick={() => setIsMobileMenuOpen(!isMobileMenuOpen)}
                            className="lg:hidden p-2 text-gray-400 hover:bg-gray-100 rounded-xl transition-colors shrink-0"
                        >
                            <Menu size={24} />
                        </button>
                        ...
                        <div className="flex items-center gap-2 sm:gap-4 pl-4 border-l border-gray-100 ml-auto">
                            ...
                            <div className="w-9 h-9 lg:w-11 lg:h-11 rounded-full bg-gradient-to-tr from-orange-500 to-orange-700 flex items-center justify-center text-white text-xs lg:text-sm font-bold shadow-md shrink-0 border-2 border-white">
                                {role?.charAt(0) || 'K'}
                            </div>
                        </div>
                    </header>
